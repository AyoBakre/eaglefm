/** Abstract base class for collection plugins v1.0.1.
  ...
  (function (e) {
      ...
      var t = window.console || function () {},
          ...
          f = function (n) {
              ...
              return e.extend(i, { activeClass: s, activeClassSelector: "." + s, requiredClass: i.classPrefix + i.requiredClass, el: this });
          },
          l = function () {
  ...
  !(function (a) {
      function b(b, d) {
          function e() {
              A.hasClass("horizontal") && ((D = "horiz"), (E = "scrollLeft"), (F = "width"), (G = "left")),
                  A.prepend('<div class="tse-scrollbar"><div class="drag-handle"></div></div>'),
          ...
          function s() {
              B.insertBefore(v), v.remove(), u.remove(), B.css({ height: A.height() + "px", "overflow-y": "scroll" }), a(window).off("resize.trackpadScollEmulator"), t("onDestroy"), A.removeData("plugin_" + c);
          }
          function t(a) {
      ...
      (a.fn[c] = function (d) {
          ...
          (a.fn[c].defaults = { onInit: function () {}, onDestroy: function () {}, wrapContent: !0, autoHide: !0 });
  })(jQuery);
